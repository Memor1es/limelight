...
Config.CooldownMinutes = 10 --10 mins

Config.CallCops = false -- Set to true if you want cops to be alerted when chopping is in progress
Config.CallCopsPercent = 1 -- (min 1) if 1 then cops will be called every time=100%, 2=50%, 3=33%, 4=25%, 5=20%.
...
Config.NPCShop = { x = 2340.51, y = 3126.17, z = 47.22, h = 333.55 } -- Location of the shop For the npc.
...
Config.Zones = {
  ...
  StanleyShop = {coords = vector3(2340.51, 3126.17, 47.22), name = _U('map_blip_shop'), color = 50, sprite = 120, radius = 25.0, Pos = { x = 2340.51, y = 3126.17, z = 47.22}, Size = { x = 3.0, y = 3.0, z = 1.0 }, },
}-- DO SANDY SHORES 2340.51, 3126.17, 47.22
