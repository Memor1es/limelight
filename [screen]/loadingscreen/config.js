var config = {
  'title': 'Limelight RP',
  'welcomeMessage': 'WELCOME TO LIMELIGHT RP',
  ...
  music: [
    'f8HtmFtGSQo', 'Fiu9h8ZTPoQ', 'VXUlwPSS-SQ', 'tgIqecROs5M'
  ],
  ...
  'discord': {
    'show': true,
    'discordLink': 'https://discord.gg/2mvz8UmC',
  },
...
var announcements = [
  'Welcome to Limelight RP. Enjoy your stay!',
  ' ',
  'After making a character, please create yourself an ID card:',
  '/char create [firstname] [lastname] [mm/dd/yy] [Male/Female]',
  'Also make sure you go to the DMV (orange car on map) for a license!',
]
...
var vehiclehotkeys = [
  ...
  'Press <kbd>LEFT ALT</kbd> to turn on s