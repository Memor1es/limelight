...
Config = {
  ...
  InfluenceInHouse  = true,          -- Gain influence inside playerhousing?
  ...
  DrugSellDist      = 7.5,           -- Distance peds will buy drugs from
  DrugBuyChance     = 20,             -- % Chance for ped to buy drugs from a player.
  SalesReportChance = 10,              -- % Chance for ped to report player to police if they didn't buy the drugs.
  SellDrugsTimer    = 5000,           -- How long does the drug deal take? (MS)
  MinSellAmount     = 1,              -- Minimum amount of drugs to sell
  MaxSellAmount     = 10,             -- Max amount of drugs to sell
  ...
  GangJobs = {                        -- List all jobs that are able to contest for and control territories here.
    "nightclub",                          -- NOTE: Don't need to include police. Thats taken from PoliceJob var above.
    "ballas",
    "vagos",
    "theblackwarriors",
  }
...
Territories = {
  ["East V"] = {
    ...
    canSell = true,                                      -- Can sell drugs in this zone? If false, no drugs can be sold here.
    ...
    actions = {
      ...
      ["gather_money"] = {
        ...
        requireCash = 15000,                              -- If not requireItem, requireCash instead. NOTE: Always dirty.
