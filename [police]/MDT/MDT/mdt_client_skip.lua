...
local ped = GetPlayerPed(-1)
	if IsPedInAnyVehicle(ped) then
		if GetVehicleClass(GetVehiclePedIsIn(ped, false)) == 18 and (GetPedInVehicleSeat(GetVehiclePedIsIn(ped), -1) == ped) or (GetPedInVehicleSeat(GetVehiclePedIsIn(ped), 0) == ped) then
			--
