...
TriggerEvent('es:addGroupCommand', 'screfresh', 'admin', function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = { '^1EASTLIFE', 'You do have permission to do that!' } })
end, {help = "Update the names in the table"})
...
TriggerEvent('es:addGroupCommand', 'sctoggle', 'admin', function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = { '^1EASTLIFE', 'You do have permission to do that!' } })
end, {help = "Deleting the ID table"})
