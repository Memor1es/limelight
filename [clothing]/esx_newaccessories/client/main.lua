...
Citizen.CreateThread(function()
	TriggerEvent('chat:addSuggestion', '/shirt',  'Take off your top', {})
	TriggerEvent('chat:addSuggestion', '/pants',  'Take off your pants', {})
	TriggerEvent('chat:addSuggestion', '/shoes',  'Take off your shoes', {})
	TriggerEvent('chat:addSuggestion', '/restore',  'Put on all your clothing', {})

	TriggerEvent('chat:addSuggestion', '/ears',  'Putting on / taking off your ear accessories', {})
	TriggerEvent('chat:addSuggestion', '/mask',  'Put on / take off your mask', {})
	TriggerEvent('chat:addSuggestion', '/hat',  'Put on / take off your helmet / hat', {})
	TriggerEvent('chat:addSuggestion', '/glasses',  'Put on / take off your glasses', {})
  end)
