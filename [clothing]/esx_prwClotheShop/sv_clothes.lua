...
AddEventHandler("parow:SetNewAcces", function(data,_source)
  ...
  TriggerClientEvent("esx:showNotification",_source,"~g~You have got a new " .. data.type )
end)
...
AddEventHandler("parow:SetNewMasque", function(mask,variation,type,label)
 ...
 -- if label == nil then
  ...
  TriggerClientEvent("parow:SyncAccess",source)
  TriggerClientEvent("esx:showNotification",source,"~g~You have got a new " .. type .."~n~~r~-50$" )
else
  TriggerClientEvent('esx:showNotification', _source, 'Not enough money (50$)')
end
end)
...
AddEventHandler("parow:RenameMasque", function(id,txt,type)
  ...
  TriggerClientEvent("esx:showNotification",source,"You have renamed your "..type.." to "..txt)
