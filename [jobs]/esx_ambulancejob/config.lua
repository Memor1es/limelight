...
Config.DrawDistance               = 200.0 -- How close do you need to be in order for the markers to be drawn (in GTA units).
...
Config.BleedoutTimer              = 60000 * 8 -- time til the player bleeds out
