(function(){
	...
	let menus = {
		...
		cloakroom : {
		  ...
		  items: [
		  	{label: 'Civilian Outfit',   value: 'citizen_wear'},
		  	{label: 'Lumberjack outfit', value: 'lumberjack_wear'}
		  ]
		},
		...
		vehiclespawner : {
		  ...
		  items: [
		  	{label: 'Delivery vehicle', value: 'mule3'}
		  ]
		},

		delivery : {
		  title     : 'Sell packs of boards',
		 	visible   : false,
		 	current   : 0,
		 	hasControl: true,
		 	template  : DefaultTpl,
