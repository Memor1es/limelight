Locales['en'] = {
  ...
  ['cadet'] = 'Cadet Outfit',
  ['deputy'] = 'Deputy Outfit',
  ['seniordeputy'] = 'Senior-Deputy Outfit',
  ['corporal'] = 'Corporal Outfit',
  ['sergeant'] = 'Sergeant Outfit',
  ['sheriff'] = 'Sheriff Outfit',
  ['bikecop'] = 'Bike Unit Outfit',
  ['detective'] = 'Detective Outfit',
  ['gangunit'] = 'Gang Unit Outfit',
  ['lt2casual'] = 'Lt Outfit',
  ['helopilot'] = 'Aviation Unit Outfit',
  ['bicyclecop'] = 'Bicycle Unit Outfit',
  ['k9unit'] = 'K9 Unit Outfit',
  ['gilet_wear'] = 'Green reflective jacket',
