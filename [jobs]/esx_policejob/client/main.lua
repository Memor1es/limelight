	...
	TriggerEvent('skinchanger:getSkin', function(skin)
		...
		if uniformObject then
			...
			if uniform ~= 'citizen_wear' then
				exports["rp-radio"]:GivePlayerAccessToFrequencies(797, 800) 
			end
			if uniform == 'citizen_wear' then 
				exports["rp-radio"]:RemovePlayerAccessToFrequencies(797, 800)
			end
...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{label = _U('cadet'), uniform = 'cadet'},
		{label = _U('deputy'), uniform = 'deputy'},
		{label = _U('seniordeputy'), uniform = 'seniordeputy'},
		{label = _U('corporal'), uniform = 'corporal'},
		{label = _U('sergeant'), uniform = 'sergeant'},
		{label = _U('sheriff'), uniform = 'sheriff'},
		{label = _U('bikecop'), uniform = 'bikecop'},
		{label = _U('detective'), uniform = 'detective'},
		{label = _U('gangunit'), uniform = 'gangunit'},
		{label = _U('lt2casual'), uniform = 'lt2casual'},
		{label = _U('helopilot'), uniform = 'helopilot'},
		{label = _U('bicyclecop'), uniform = 'bicyclecop'},
		{label = _U('k9unit'), uniform = 'k9unit'},
