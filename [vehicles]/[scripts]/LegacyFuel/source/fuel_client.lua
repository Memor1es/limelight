...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			if displayHud then
				DrawAdvancedText(0.2195 - x, 0.8880 - y, 0.077, 0.0028, 0.5, fuel, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.148 - x, 0.8890 - y, 0.057, 0.0028, 0.5, "                            Fuel:", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
